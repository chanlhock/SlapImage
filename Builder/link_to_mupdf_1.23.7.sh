...
MUPDF_JAVA=$MUPDF_ROOT/platform/SlapImage
mkdir -p -p $MUPDF_JAVA/jni
...
FDRIOD_NDK_VERSION="29.0.13113456"
if [ "$(uname)" == "Darwin" ]; then
  FDRIOD_NDK_VERSION=$NDK_VERSION
fi

PATH1=/Users/ethan/Library/Android/sdk/ndk/
PATH2=/Users/ethan/Library/Android/sdk/ndk/
...
if [ "$1" == "fdroid" ]; then
  for NDK in "/Users/ethan/Library/Android/sdk/ndk/ndk-build";
    do
      if [ -f "$NDK" ]; then
