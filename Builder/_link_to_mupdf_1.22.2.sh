...
if [ "$1" == "clean_ndk" ]; then
/Users/ethan/Library/Android/sdk/ndk/29.0.13113456/ndk-build clean
/Users/ethan/Library/Android/sdk/ndk/29.0.13113456/ndk-build clean
...
for NDK in "/Users/ethan/Library/Android/sdk/ndk/$NDK_VERSION/ndk-build" "/Users/ethan/Library/Android/sdk/ndk/$NDK_VERSION/ndk-build";
do
  if [ -f "$NDK" ]; then
