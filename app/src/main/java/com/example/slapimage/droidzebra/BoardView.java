...
import com.example.slapimage.droidzebra.ZebraEngine.InvalidMove;
...
public class BoardView extends View {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		Typeface font = Typeface.create(Typeface.SANS_SERIF, Typeface.BOLD);		// BOLD
		...
		mPaintEvalText.setTextScaleX(1.0f);		// 1.0f
		mPaintEvalText.setTextSize(mSizeCell*0.5f);		// chanlhock 0.5f
