...
package com.example.slapimage.droidzebra;

import java.util.Calendar;
import java.util.Date;

import com.example.slapimage.droidzebra.ZebraEngine;
import com.example.slapimage.droidzebra.ZebraEngine.CandidateMove;
import com.example.slapimage.droidzebra.ZebraEngine.Move;
import com.example.slapimage.droidzebra.ZebraEngine.PlayerInfo;
...
public boolean onOptionsItemSelected(MenuItem item) {
	...
	try {
		...
		if (id == R.id.menu_new_game) {
			...
			showQuitDialog();
			return true;
		} else if (id == R.id.menu_take_back) {
			mZebraThread.undoMove();
			return true;
		} else if (id == R.id.menu_take_redo) {
			mZebraThread.redoMove();
			return true;
			...
			startActivity(i);
			return true;
		} else if (id == R.id.menu_switch_sides) {
			switchSides();
			return true;
	...
	public static class DialogPass extends DialogFragment {
	    ...
	    public Dialog onCreateDialog(Bundle savedInstanceState) {
			...
			.setTitle(R.string.zebra_app_name)
