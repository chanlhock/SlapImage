...
import com.example.slapimage.databinding.ActivityPlayerBinding
import com.example.slapimage.databinding.AudioBoosterBinding
...
class PlayerActivity : AppCompatActivity(), ServiceConnection, MediaPlayer.OnCompletionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        }catch (_: Exception){Toast.makeText(this,  "Equalizer Feature not Supported!!", Toast.LENGTH_SHORT).show()}
        }
...
//Important Function
    private fun initializeLayout(){
        ...
        when(intent.getStringExtra("class")){
            ...
            "MusicAdapterSearch"-> initServiceAndPlaylist(MainMusicActivity.musicListSearch, shuffle = false)
            "MusicAdapter" -> initServiceAndPlaylist(MainMusicActivity.MusicListMA, shuffle = false)
            "FavouriteAdapter"-> initServiceAndPlaylist(FavouriteActivity.favouriteSongs, shuffle = false)
            "MainMusicActivity"-> initServiceAndPlaylist(MainMusicActivity.MusicListMA, shuffle = true)
