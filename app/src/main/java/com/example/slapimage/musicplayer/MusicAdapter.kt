...
import com.example.slapimage.musicplayer.MusicAdapter.MyHolder
import com.example.slapimage.databinding.DetailsViewBinding
import com.example.slapimage.databinding.MoreFeaturesBinding
import com.example.slapimage.databinding.MusicViewBinding
...
//                        .setBackground(ColorDrawable(0x99000000.toInt()))
        ...
        when{
            ...
            selectionActivity ->{
                ...
                holder.root.setOnClickListener {
                when{
                    MainMusicActivity.search -> sendIntent(ref = "MusicAdapterSearch", pos = position)
