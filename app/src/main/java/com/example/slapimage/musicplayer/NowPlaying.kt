...
import com.example.slapimage.databinding.FragmentNowPlayingBinding
...
class NowPlaying : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        requireContext().theme.applyStyle(MainMusicActivity.currentTheme[MainMusicActivity.themeIndex], true)
