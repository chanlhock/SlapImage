...
import com.example.slapimage.databinding.FragmentSettingsBirthdaysBinding
        ...
        fragmentSettingsBirthdaysBinding.clBirthdayTime.setOnClickListener {
            val timeSetListener =
                TimePickerDialog.OnTimeSetListener { _: TimePicker?, h: Int, m: Int ->
                    ...
                    AlarmHandler.setBirthdayAlarms(newTime, activity as PocketPlanMainActivity)
            ...
            tpd.getButton(AlertDialog.BUTTON_NEGATIVE)
                .setTextColor(
                    (activity as PocketPlanMainActivity).colorForAttr(R.attr.colorOnBackGround)
                )
