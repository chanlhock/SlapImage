package com.example.slapimage.pocket_plan.j7_003.data.todolist
...
import com.example.slapimage.databinding.DialogAddTaskBinding
import com.example.slapimage.databinding.FragmentTodoBinding
import com.example.slapimage.databinding.RowTaskBinding
...
class TodoFr : Fragment() {
    ...
    fun preloadAddTaskDialog(passedActivity: PocketPlanMainActivity, myLayoutInflater: LayoutInflater){
        ...
        taskConfirmButtons.forEachIndexed { index, button ->
            button.setOnClickListener {
                ...
                if(PocketPlanMainActivity.previousFragmentStack.peek() == FT.POCKETPLAN_HOME){
                    val homeFr = myActivity.getFragment(FT.POCKETPLAN_HOME) as HomeFr
...
class TodoTaskAdapter(activity: PocketPlanMainActivity, private var myFragment: TodoFr) :
