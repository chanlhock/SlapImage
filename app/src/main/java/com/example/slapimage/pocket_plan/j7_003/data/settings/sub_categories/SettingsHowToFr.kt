package com.example.slapimage.pocket_plan.j7_003.data.settings.sub_categories
...
import com.example.slapimage.databinding.FragmentSettingsHowToBinding
import com.example.slapimage.databinding.RowHowtoBinding
import com.example.slapimage.databinding.RowHowtoCatBinding
...
class SettingsHowTo : Fragment() {
    ...
    lateinit var myActivity: PocketPlanMainActivity
 ...
 * CATEGORY ADAPTER
 */
class HowToAdapter(private val myFragment: SettingsHowTo, val myActivity: PocketPlanMainActivity) :
 ...
 * SUB ADAPTER
 */
class SubHowToAdapter(private val myFragment: SettingsHowTo, val category: HowToCategory, val myActivity: PocketPlanMainActivity) :
