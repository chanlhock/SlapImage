package com.example.slapimage.pocket_plan.j7_003.data.notelist
...
import com.example.slapimage.pocket_plan.j7_003.PreferenceIDs
...
import com.example.slapimage.databinding.DialogChooseColorBinding
import com.example.slapimage.databinding.DialogDiscardNoteEditBinding
import com.example.slapimage.databinding.DialogMoveNoteBinding
import com.example.slapimage.databinding.FragmentNoteEditorBinding
...
class NoteEditorFr : Fragment() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.item_editor_save -> {
                ...
                PocketPlanMainActivity.previousFragmentStack.pop()
                myActivity.changeToFragment(PocketPlanMainActivity.previousFragmentStack.peek())
            }
        }
    ...
    fun dialogDiscardNoteChanges(fragmentTag: FT = FT.EMPTY) {
        ...
        dialogDiscardNoteEdit.btnDiscardChanges.setOnClickListener {
            if (fragmentTag != PocketPlanMainActivity.previousFragmentStack.pop() && fragmentTag != FT.EMPTY) {
                PocketPlanMainActivity.previousFragmentStack.push(fragmentTag)
            }
    ...
    private fun manageAddNote() {
        ...
        val cache = PocketPlanMainActivity.previousFragmentStack.pop()
        if (PocketPlanMainActivity.previousFragmentStack.peek() == FT.POCKETPLAN_HOME) {
            Toast.makeText(myActivity, R.string.notesNotificationNoteAdded, Toast.LENGTH_SHORT)
                .show()
        }
        PocketPlanMainActivity.previousFragmentStack.push(cache)
    }
    ...
    private fun openDeleteNoteDialog() {
        ...
        val action: () -> Unit = {
            ...
            myNoteFr.noteListDirs.save()
            myActivity.hideKeyboard()
            PocketPlanMainActivity.previousFragmentStack.push(FT.EMPTY)
