...
import com.example.slapimage.pocket_plan.j7_003.data.shoppinglist.ShoppingFr
import com.example.slapimage.databinding.FragmentSettingsShoppingBinding
...
class SettingsShoppingFr : Fragment() {
    ...
    private fun initializeListeners() {
        ...
        fragmentBinding.clManageCustomItems.setOnClickListener {
            (activity as PocketPlanMainActivity).changeToFragment(FT.CUSTOM_ITEMS)
        }
