...
import com.example.slapimage.pocket_plan.j7_003.data.birthdaylist.BirthdayFr
import com.example.slapimage.pocket_plan.j7_003.data.birthdaylist.BirthdayList
import com.example.slapimage.pocket_plan.j7_003.data.fragmenttags.FT
import com.example.slapimage.pocket_plan.j7_003.data.home.HomeFr
import com.example.slapimage.pocket_plan.j7_003.data.notelist.NoteColors
import com.example.slapimage.pocket_plan.j7_003.data.notelist.NoteDirList
import com.example.slapimage.pocket_plan.j7_003.data.notelist.NoteEditorFr
import com.example.slapimage.pocket_plan.j7_003.data.notelist.NoteFr
...
import com.example.slapimage.pocket_plan.j7_003.data.settings.SettingsMainFr
import com.example.slapimage.pocket_plan.j7_003.data.settings.SettingsManager
import com.example.slapimage.pocket_plan.j7_003.data.settings.sub_categories.*
import com.example.slapimage.pocket_plan.j7_003.data.settings.sub_categories.shoppinglist.CustomItemFr
import com.example.slapimage.pocket_plan.j7_003.data.settings.sub_categories.shoppinglist.SettingsShoppingFr
import com.example.slapimage.pocket_plan.j7_003.data.shoppinglist.ItemTemplateList
import com.example.slapimage.pocket_plan.j7_003.data.shoppinglist.MultiShoppingFr
import com.example.slapimage.pocket_plan.j7_003.data.shoppinglist.ShoppingListWrapper
import com.example.slapimage.pocket_plan.j7_003.data.shoppinglist.UserItemTemplateList
import com.example.slapimage.pocket_plan.j7_003.data.sleepreminder.SleepFr
import com.example.slapimage.pocket_plan.j7_003.data.todolist.TodoFr
import com.example.slapimage.pocket_plan.j7_003.data.todolist.TodoList
import com.example.slapimage.pocket_plan.j7_003.data.todolist.TodoTaskAdapter
import com.example.slapimage.databinding.DialogConfirmBinding
import com.example.slapimage.databinding.DrawerLayoutBinding
import com.example.slapimage.databinding.HeaderNavigationDrawerBinding
import com.example.slapimage.databinding.TitleDialogBinding
import com.example.slapimage.pocket_plan.j7_003.system_interaction.handler.notifications.AlarmHandler
import com.example.slapimage.pocket_plan.j7_003.system_interaction.handler.storage.StorageHandler
...
class PocketPlanMainActivity : AppCompatActivity() {
    ...
    fun getFragment(tag: FT): Fragment? = when (tag) {
        ...
        FT.POCKETPLAN_HOME -> homeFr as HomeFr
        else -> null
    }
    ...
    //When activity is entered via special intent, change to respective fragment
        ...
        "SReminder" -> changeToFragment(FT.POCKETPLAN_HOME)
        "settings" -> changeToFragment(FT.SETTINGS)
        "general" -> {
            previousFragmentStack.push(FT.POCKETPLAN_HOME)
        ...
        "backup" -> {
            ...
            if (previousFragmentStack.peek() == FT.EMPTY) {
                changeToFragment(FT.POCKETPLAN_HOME)
            } else {
    ...
    try {
        ...
        val navList = arrayListOf(FT.NOTES, FT.TASKS, FT.POCKETPLAN_HOME, FT.SHOPPING, FT.BIRTHDAYS)
        bottomNavigation.setOnItemSelectedListener { item ->
            ...
            if (!navList.contains(previousFragmentStack.peek()) || bottomNavigation.selectedItemId != item.itemId) {
                when (item.itemId) {
                    ...
                    R.id.bottom3 -> changeToFragment(FT.POCKETPLAN_HOME)
...
*/
    ...
    fun changeToFragment(fragmentTag: FT, exitingFragment: Boolean = false): Fragment? {
        ...
        toolbar.title = when (fragmentTag) {
            FT.POCKETPLAN_HOME -> resources.getText(R.string.menuTitleHome)
