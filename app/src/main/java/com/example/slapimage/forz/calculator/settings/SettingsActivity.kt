package com.example.slapimage.forz.calculator.settings
...
//import com.example.slapimage.forz.calculator.App
import com.example.slapimage.forz.calculator.utils.NumberFormatter
import com.example.slapimage.R
import com.example.slapimage.forz.calculator.colorThemes.Color
import com.example.slapimage.forz.calculator.colorThemes.ColorActionListener
import com.example.slapimage.forz.calculator.colorThemes.ColorAdapter
import com.example.slapimage.databinding.ActivityCalcxsettingsBinding
import com.example.slapimage.forz.calculator.history.HistoryService
import com.example.slapimage.forz.calculator.settings.Config.color
import com.example.slapimage.forz.calculator.settings.Config.decimalSeparatorSymbol
import com.example.slapimage.forz.calculator.settings.Config.groupingSeparatorSymbol
import com.example.slapimage.forz.calculator.settings.Config.isDynamicColor
import com.example.slapimage.forz.calculator.settings.Config.numberPrecision
import com.example.slapimage.forz.calculator.settings.Config.oldDecimalSeparatorSymbol
import com.example.slapimage.forz.calculator.settings.Config.oldGroupingSeparatorSymbol
import com.example.slapimage.forz.calculator.settings.Config.sound
import com.example.slapimage.forz.calculator.settings.Config.swipeDigitsAndScientificFunctions
import com.example.slapimage.forz.calculator.settings.Config.swipeMain
import com.example.slapimage.forz.calculator.settings.Config.vibration
import com.example.slapimage.forz.calculator.expression.ExpressionViewModel
import com.example.slapimage.forz.calculator.settings.Config.maxScientificNotationDigits
...
class SettingsActivity : AppCompatActivity() {
    ...
    private var binding: ActivityCalcxsettingsBinding by notNull()
    ...
    private val historyService: HistoryService
        get() = (this.applicationContext as ApplicationClass).historyService
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCalcxsettingsBinding.inflate(layoutInflater).also { setContentView(it.root) }
