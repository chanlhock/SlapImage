package com.example.slapimage.forz.calculator.fragments.small
...
import com.example.slapimage.forz.calculator.OnMainActivityListener
import com.example.slapimage.R
import com.example.slapimage.databinding.FragmentSmallBinding
import com.example.slapimage.forz.calculator.fragments.HistoryFragment
import com.example.slapimage.forz.calculator.fragments.adapters.ViewPageAdapter
import com.example.slapimage.forz.calculator.settings.Config
import com.example.slapimage.forz.calculator.calculator.CalculatorViewModel
import com.example.slapimage.forz.calculator.calculator.Evaluator
import com.example.slapimage.forz.calculator.calculator.TrigonometricFunction
import com.example.slapimage.forz.calculator.expression.ExpressionViewModel
import com.example.slapimage.forz.calculator.expression.ExpressionViewModel.cursorPositionStart
import com.example.slapimage.forz.calculator.expression.ExpressionViewModel.expression
import com.example.slapimage.forz.calculator.expression.ExpressionViewModel.oldExpression
import com.example.slapimage.forz.calculator.fragments.CalculatorFragment
import com.example.slapimage.forz.calculator.fragments.Fragments.CALCULATOR_FRAGMENT
import com.example.slapimage.forz.calculator.fragments.Fragments.HISTORY_FRAGMENT
import com.example.slapimage.forz.calculator.fragments.Fragments.UNIT_CONVERTER_FRAGMENT
import com.example.slapimage.forz.calculator.fragments.Fragments.currentItemMainPager
import com.example.slapimage.forz.calculator.fragments.UnitConverterFragment
import com.example.slapimage.forz.calculator.history.HistoryService
import com.example.slapimage.forz.calculator.settings.Config.autoSavingResults
import com.example.slapimage.forz.calculator.settings.SettingsActivity
import com.example.slapimage.forz.calculator.utils.HapticAndSound
import com.example.slapimage.forz.calculator.utils.InsertInExpression
    ...
    UnitConverterFragment.OnButtonClickListener
{
    ...
    private var binding: FragmentSmallBinding by notNull()
    private var hapticAndSound: HapticAndSound by notNull()


    private val historyService: HistoryService
        get() = (requireContext().applicationContext as ApplicationClass).historyService
        ...
        binding.toolbar.setOnMenuItemClickListener { menuItem ->
            when(menuItem.itemId) {
                R.id.settings -> {
                    ...
                    startActivityForResult(intent, CalcxMainActivity.REQUEST_CODE_CHILD)
                    true
                }
                R.id.clearHistory -> {
