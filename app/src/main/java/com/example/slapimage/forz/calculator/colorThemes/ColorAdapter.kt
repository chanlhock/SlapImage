...
import com.example.slapimage.databinding.CalcItemColorBinding
...
class ColorAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ColorViewHolder {
        ...
        val binding = CalcItemColorBinding.inflate(inflater, parent, false)
    ...
    class ColorViewHolder(
        val binding: CalcItemColorBinding
