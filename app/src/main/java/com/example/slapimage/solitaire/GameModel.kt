...
import com.example.slapimage.solitaire.GamePresenter.view
...
object GameModel {
    ...
    fun onTableauTap(tableauIndex: Int, cardIndex: Int) {
        ...
        if (tableauPile.cards.isNotEmpty() && cardIndex < tableauPile.cards.size) { // Add bounds check
            if (tableauPile.cards[cardIndex].faceUp) {
                val cards = tableauPile.cards.subList(cardIndex, tableauPile.cards.size) // Use size instead of lastIndex
                if (playCards(cards)) {
