...
import com.example.slapimage.openbible.logic.checkTranslation
import com.example.slapimage.openbible.logic.getAppName
import com.example.slapimage.openbible.logic.getChapter
import com.example.slapimage.openbible.logic.getSelection
import com.example.slapimage.openbible.logic.getShowVerseNumbers
import com.example.slapimage.openbible.logic.getSplitScreen
import com.example.slapimage.openbible.logic.getTextAlignment
import com.example.slapimage.openbible.logic.turnChapter
...
fun ReadCard(
   ...
   // val selection = remember { mutableStateOf(getSelection(context, isSplitScreen)) }
    // Optimized:
    val selection = remember(isSplitScreen) {
   ...
   /* val (title, text) = getChapter(
        ...
        stringResource(R.string.openbible_error)
    )*/
    // Optimized solution:
    val errorMessage = stringResource(R.string.openbible_error)

    val (title, text) = remember(book, chapter) {
        derivedStateOf {
            runBlocking(Dispatchers.IO) { // Move to background thread
                getChapter(
                    context,
                    translation,
                    book,
