...
import com.example.slapimage.openbible.logic.ReadTextAlignment
import com.example.slapimage.openbible.logic.SchemeOption
import com.example.slapimage.openbible.logic.SplitScreen
import com.example.slapimage.openbible.logic.ThemeOption
import com.example.slapimage.openbible.logic.backupData
import com.example.slapimage.openbible.logic.checkForUpdates
import com.example.slapimage.openbible.logic.downloadTranslation
import com.example.slapimage.openbible.logic.getCheckAtStartup
import com.example.slapimage.openbible.logic.getColorSchemeInt
import com.example.slapimage.openbible.logic.getDownloadNotification
import com.example.slapimage.openbible.logic.getIndexPath
import com.example.slapimage.openbible.logic.getLanguageName
import com.example.slapimage.openbible.logic.getMainThemeOptions
import com.example.slapimage.openbible.logic.getShowVerseNumbers
import com.example.slapimage.openbible.logic.getSplitScreenInt
import com.example.slapimage.openbible.logic.getTextAlignmentInt
import com.example.slapimage.openbible.logic.getTranslation
import com.example.slapimage.openbible.logic.getTranslationList
import com.example.slapimage.openbible.logic.getTranslations
import com.example.slapimage.openbible.logic.saveCheckAtStartup
import com.example.slapimage.openbible.logic.saveColorScheme
import com.example.slapimage.openbible.logic.saveDownloadNotification
import com.example.slapimage.openbible.logic.saveIndex
import com.example.slapimage.openbible.logic.saveShowVerseNumbers
import com.example.slapimage.openbible.logic.saveSplitScreen
import com.example.slapimage.openbible.logic.saveTextAlignment
...
fun SettingsScreen(
    ...
    onThemeChange: (Boolean?, Boolean?, Boolean?) -> Unit
        ...
        val scope = rememberCoroutineScope() // Get the coroutine scope
        Scaffold(topBar = {
            TopAppBar(title = { Text(stringResource(R.string.settings)) }, navigationIcon = {
                IconButton(onClick = {
                    scope.launch {      // fix delay issue chanlhock
                        delay(50) // Small delay to let UI settle
                        onNavigateToRead()
                    }
                }) {
                    Icon(
        ...
        /*        HorizontalDivider(Modifier.padding(12.dp))
                ...
                Row(
                    ...
                    LinkButton(
                        ...
                        url = "https://play.google.com/store/apps/details?id=com.example.slapimage.openbible"
                    )
                    LinkButton(
...
fun ThemeButton(onThemeChange: (Boolean?, Boolean?, Boolean?) -> Unit) {
    ...
    SingleChoiceSegmentedButtonRow(Modifier.fillMaxWidth()) {
        options.forEachIndexed { index, option ->
            val label = when (option) {
                ThemeOption.System -> stringResource(R.string.openbible_theme_system)
