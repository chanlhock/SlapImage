...
import com.example.slapimage.openbible.logic.deserialize
...
import com.example.slapimage.openbible.logic.getTranslationPath
import com.example.slapimage.openbible.logic.restoreBackup
...
*/
// StartScreen.kt - Optimized Loading
@Composable
fun Loading(onLoaded: () -> Unit, file: String, maxSeconds: Int = 20) {
    ...
    LaunchedEffect(file) {
        withContext(Dispatchers.IO) {
            var counter = 0
            while (isLoading && counter < maxSeconds * 10) {
