...
@Composable
fun TabContent(modifier: Modifier = Modifier, file: com.example.slapimage.xededitor.file_wrapper.FileObject, type: FragmentType, viewModel: MainViewModel = viewModel()) {
    when(type){
        FragmentType.EDITOR -> {
            CodeEditor(
                modifier = Modifier
