...
import com.example.slapimage.xededitor.karbon_exec.launchTermux
...
object MenuClickHandler {
    ...
    suspend fun handle(activity: XEDMainActivity, menuItem: MenuItem): Boolean {
    ...
    private fun handleReplace(activity: XEDMainActivity): Boolean {
        val popupView =
    ...
    private fun replaceAll(popupView: View, activity: XEDMainActivity) {
    ...
    private fun handleSearchClose(activity: XEDMainActivity): Boolean {
        val editorFragment =
            if (activity.adapter!!.getCurrentFragment()?.fragment is EditorFragment) {
                activity.adapter!!.getCurrentFragment()?.fragment as EditorFragment
            } else {
    ...
    private fun handleSearch(activity: XEDMainActivity): Boolean {
        val popupView =
    ...
    private fun initiateSearch(activity: XEDMainActivity, searchBox: EditText, popupView: View) {
