package com.example.slapimage.xededitor.xededitor.ui.screens.settings.mutators
...
import com.example.slapimage.xededitor.xededitor.ui.components.InfoBlock
                    ...
                    PreferenceTemplate(modifier = modifier.clickable {
                        DefaultScope.launch {
                            ...
                            withContext(Dispatchers.Main) {
                                XEDMainActivity.activityRef.get()?.adapter?.addFragment(
                                    FileWrapper(
                                        file
                                    )
                                )
