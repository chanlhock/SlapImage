package com.example.slapimage.xededitor.xededitor.ui.screens.settings.terminal
...
import com.example.slapimage.xededitor.karbon_exec.isTermuxCompatible
import com.example.slapimage.xededitor.karbon_exec.isTermuxInstalled
import com.example.slapimage.xededitor.karbon_exec.testExecPermission
...
import com.example.slapimage.xededitor.xededitor.ui.components.BottomSheetContent
        ...
        PreferenceGroup {
            ...
            val backup = rememberLauncherForActivityResult(
                ...
                MaterialAlertDialogBuilder(activity ?: context).apply {
                    ...
                    val popupView: View = LayoutInflater.from(XEDMainActivity.activityRef.get()!!).inflate(R.layout.popup_new, null)
