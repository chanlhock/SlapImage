...
import com.example.slapimage.xededitor.compose.filetree.addProject
import com.example.slapimage.xededitor.compose.filetree.fileTreeViewModel
...
class FileManager(private val mainActivity: XEDMainActivity) {
