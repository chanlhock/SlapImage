package com.example.slapimage.xededitor.controlpanel
...
fun XEDMainActivity.showControlPanel() {
                                                ...
                                                lifecycleScope.launch{
                                                    if (tabViewModel.fragmentFiles.isNotEmpty()) {
                                                        withContext(Dispatchers.IO) {
                                                            com.example.slapimage.xededitor.xededitor.MainActivity.tabs.editor.saveAllFiles()
                                                        }
                                                    }
                                                }
                                            }
