...
import com.example.slapimage.xededitor.xededitor.MainActivity.handlers.KeyEventHandler
import com.example.slapimage.xededitor.xededitor.ui.theme.ThemeManager
...
abstract class BaseActivity : AppCompatActivity() {
    ...
    override fun onKeyDown(keyCode: Int, event: KeyEvent?): Boolean {
        if (event != null) {
            if (this::class.java.name == XEDMainActivity::class.java.name){
