package com.example.slapimage.xededitor.xededitor.MainActivity
...
import com.example.slapimage.xededitor.compose.filetree.DrawerContent
import com.example.slapimage.xededitor.compose.filetree.isLoading
import com.example.slapimage.xededitor.compose.filetree.restoreProjects
import com.example.slapimage.xededitor.compose.filetree.saveProjects
...
import com.example.slapimage.xededitor.libcommons.UI
...
import com.example.slapimage.xededitor.runner.Runner
import com.example.slapimage.xededitor.settings.Settings
import com.example.slapimage.xededitor.xededitor.BaseActivity
import com.example.slapimage.xededitor.xededitor.MainActivity.file.FileManager
import com.example.slapimage.xededitor.xededitor.MainActivity.file.TabSelectedListener
import com.example.slapimage.xededitor.xededitor.MainActivity.file.getFragmentType
import com.example.slapimage.xededitor.xededitor.MainActivity.handlers.MenuClickHandler
import com.example.slapimage.xededitor.xededitor.MainActivity.handlers.PermissionHandler
import com.example.slapimage.xededitor.xededitor.MainActivity.handlers.updateMenu
import com.example.slapimage.xededitor.xededitor.MainActivity.tabs.core.FragmentType
import com.example.slapimage.xededitor.xededitor.MainActivity.tabs.editor.EditorFragment
import com.example.slapimage.xededitor.xededitor.MainActivity.tabs.editor.saveAllFiles
import com.example.slapimage.R
import com.example.slapimage.databinding.ActivityTabBinding
import com.example.slapimage.xededitor.xededitor.ui.screens.settings.feature_toggles.InbuiltFeatures
import com.example.slapimage.xededitor.xededitor.ui.screens.settings.mutators.ImplAPI
...
class XEDMainActivity : BaseActivity() {

    companion object {
        var activityRef = WeakReference<XEDMainActivity?>(null)
        fun withContext(invoke: XEDMainActivity.() -> Unit) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            SetupEditor.initActivity(this@XEDMainActivity, calculateColors = {
                val lightThemeContext = ContextThemeWrapper(
                    this@XEDMainActivity,
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (id == android.R.id.home) {
            ...
            lifecycleScope.launch {
                MenuClickHandler.handle(this@XEDMainActivity, item)
            }
            return false
        }
    }
    ...
    private fun setupTabLayout() {
        binding!!.tabs.addOnTabSelectedListener(TabSelectedListener(this@XEDMainActivity))
