            ...
            Runnable r = new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        InterstitialAd.load(ApplicationClass.context, Apps.getMetaData(ApplicationClass.context, "librera.ADMOB_FULLSCREEN_ID"), ADS.getAdRequest(a), new InterstitialAdLoadCallback() {
                            @Override
