...
public class Urls {
    ...
    public static void openPdfPro(Context a) {
        try {
            open(a, "market://details?id=com.example.slapimage.ibook.foobnix.pro.pdf.reader");
        } catch (Exception e) {
            // android 1.6
            open(a, "https://play.google.com/store/apps/details?id=com.example.slapimage.ibook.foobnix.pro.pdf.reader");
        }
    }
