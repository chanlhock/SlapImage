...
import com.example.slapimage.ibook.foobnix.android.utils.MyMath;
...
import com.example.slapimage.ibook.foobnix.pdf.info.MyADSProvider;
...
public abstract class DocumentController {
    ...
    public static void doContextMenu(Activity a) {
        ...
        ComponentName compName = new ComponentName(a.getPackageName(), "com.example.slapimage.ibook.foobnix.zipmanager.SendReceiveActivityAlias");
