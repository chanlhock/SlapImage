package com.example.slapimage.ibook.foobnix.sys;

import static com.example.slapimage.ibook.foobnix.pdf.info.io.SearchCore.SUPPORTED_EXT_FILES_ONLY;
...
import com.example.slapimage.ibook.foobnix.ext.CalirbeExtractor;
import com.example.slapimage.ibook.foobnix.ext.CbzCbrExtractor;
import com.example.slapimage.ibook.foobnix.ext.EbookMeta;
   ...
   public Bitmap coverPDFNative(PageUrl pageUrl) {
    ...
    public Bitmap proccessCoverPage(PageUrl pageUrl) {
            ...
            if (root.isDirectory()) {
                ...
                if (listFiles == null || listFiles.length == 0) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        Drawable drawable = ApplicationClass.context.getDrawable(R.drawable.glyphicons_145_folder_open);
                        ...
                        return BitmapFactory.decodeResource(ApplicationClass.context.getResources(), R.drawable.gitbook);
                    }
                }
        ...
        if (ebookMeta.coverImage != null) {
            ...
            cover = BitmapFactory.decodeResource(ApplicationClass.context.getResources(), R.drawable.gitbook);
    ...
    public InputStream getStreamInner(final String imageUri, String hash) throws IOException {
        ...
        if (imageUri.startsWith("assets:")) {
            return ApplicationClass.context.getResources().getAssets().open(imageUri.replace("assets://", ""));
        }
