...
import com.example.slapimage.ibook.foobnix.android.utils.Intents;
...
import com.example.slapimage.ibook.foobnix.pdf.search.activity.msg.MessageCenterHorizontally;
...
public abstract class HorizontalModeController extends DocumentController {
    ...
    @Override
    public synchronized void getOutline(final com.example.slapimage.ibook.foobnix.android.utils.ResultResponse<List<OutlineLinkWrapper>> outlineResonse, boolean forse) {
        if (codeDocument == null) {
    ...
    @Override
    public void doSearch(final String text, final com.example.slapimage.ibook.foobnix.android.utils.ResultResponse<Integer> result) {
