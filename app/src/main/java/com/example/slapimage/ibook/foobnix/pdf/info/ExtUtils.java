...
import com.example.slapimage.ibook.foobnix.pdf.search.activity.HorizontalModeController;
...
import com.example.slapimage.ibook.foobnix.zipmanager.ZipDialog;
...
public class ExtUtils {
    ...
    public static String readableFileSize(long size) {
        if (true) {
            return Formatter.formatFileSize(ApplicationClass.context, size).replace(" ", "");
        }
        if (size <= 0)
            return "0";
