...
import com.example.slapimage.ibook.foobnix.pdf.info.view.ScaledImageView;
...
public class FileInformationDialog {
    ...
    public static void showImage(Activity a, String path) {
        ...
        Glide.with(a).asBitmap().load(url).into(imageView);      // ApplicationClass.context
    ...
    public static void showImageHttpPath(Context a, String path) {
        ...
        Glide.with(a).asBitmap().load(path).into(imageView);     //ApplicationClass.context
