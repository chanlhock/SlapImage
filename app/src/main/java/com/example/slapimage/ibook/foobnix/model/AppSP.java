...
public class AppSP {
    ...
    public String currentProfile = AppsConfig.IS_LOG ? "BETA" : "SlapImage";
    public String rootPath = new File(Environment.getExternalStorageDirectory(), "SlapImage").toString();
