...
import static com.example.slapimage.ibook.foobnix.model.AppProfile.SYNC_FOLDER_DEVICE_PROFILE;
...
public class AppData {
    ...
    public static File getTestFileName() {
        File logFile = new File(AppProfile.syncTestFolder, Apps.getApplicationName(ApplicationClass.context) + "_" + Apps.getVersionName(ApplicationClass.context) + "_" + AppsConfig.MUPDF_FZ_VERSION + ".txt");
        return logFile;
