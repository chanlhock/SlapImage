...
import com.example.slapimage.privacyfriendlysudoku.controller.qqwing.PrintStyle;
import com.example.slapimage.privacyfriendlysudoku.controller.qqwing.QQWing;
import com.example.slapimage.privacyfriendlysudoku.controller.qqwing.Symmetry;
...
import static com.example.slapimage.privacyfriendlysudoku.controller.NewLevelManager.PRE_SAVES_MIN;
...
public class GeneratorService extends JobIntentService {
    ...
    private void showNotification(GameType gameType, GameDifficulty gameDifficulty) {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, ApplicationClass.CHANNEL_ID_SUDOKU);
        builder.setContentTitle(getString(R.string.sudoku_app_name));
        ...
        builder.setContentIntent(PendingIntent.getActivity(this, 0, new Intent(this, SudokuMainActivity.class), FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE));
