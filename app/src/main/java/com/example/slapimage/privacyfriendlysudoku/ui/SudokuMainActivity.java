 ...
 */
package com.example.slapimage.privacyfriendlysudoku.ui;
...
import com.example.slapimage.privacyfriendlysudoku.controller.NewLevelManager;
...
import com.example.slapimage.privacyfriendlysudoku.ui.listener.IImportDialogFragmentListener;
import com.example.slapimage.R;

import java.util.LinkedList;
import java.util.List;

import static com.example.slapimage.privacyfriendlysudoku.ui.TutorialActivity.ACTION_SHOW_ANYWAYS;

public class SudokuMainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener, IImportDialogFragmentListener{
...
private boolean goToNavigationItem(int id) {
    ...
    if (id == R.id.menu_settings_main) {
        //open settings
        intent = new Intent(this, SettingsActivity.class);
        startActivity(intent);
        overridePendingTransition(0, 0);
    }
    else if (id == R.id.nav_highscore_main) {
        // see highscore list
        intent = new Intent(this, StatsActivity.class);
        startActivity(intent);
        overridePendingTransition(0, 0);
    ...
    else if (id == R.id.nav_dailySudoku_main) {
        intent = new Intent(this, DailySudokuActivity.class);
        startActivity(intent);
        overridePendingTransition(0, 0);
    }
    ...
    public void onImportDialogPositiveClick(String input) {
        ...
        if (inputSudoku == null) {
            Toast.makeText(SudokuMainActivity.this,
        ...
        if (!validSize) {
            Toast.makeText(SudokuMainActivity.this, R.string.failed_to_verify_custom_sudoku_toast, Toast.LENGTH_LONG).show();
            return;
        }
        ...
        if (solvable) {
            Toast.makeText(SudokuMainActivity.this, R.string.finished_verifying_custom_sudoku_toast, Toast.LENGTH_LONG).show();
