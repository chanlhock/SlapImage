...
#define JNIFn(Package, Class, Fname) JNICALL Java_com_example_slapimage_##Package##_##Class##_##Fname
...
{
    jclass exc = (*env)->FindClass(env, "com/example/slapimage/droidzebra/EngineError");
