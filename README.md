...
- 8th June 2026: Decided to stop further code development and achive this project in order to free up disk space by removing Android Studio on my MacBook Air. Planning to use the freed up disk space of roughly 40GB to explore and learn Unity Game Engine. 
